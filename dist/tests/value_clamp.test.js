...
describe("ValueClamp", () => {
    ...
    test("should clamp maximum values in the Dto object", () => {
        ...
        let dto = company_data_1.default.deserialize(data);
